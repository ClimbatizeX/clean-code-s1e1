...
var createNewTaskElement=function(taskString){
    ...
    listItem.classList.add('tasks__list-item', 'task');
    ...
    checkBox.classList.add('task__done');
    editInput.type="text";
    editInput.classList.add('task__input', 'text-input');

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.classList.add("task__button", "button");

    deleteButton.classList.add("task__delete", "delete-button");
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".task__done");
